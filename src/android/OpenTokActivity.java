...
//    mContainer = (ConstraintLayout) findViewById(R.id.main_container);
   ...
   /* mPublisherViewContainer = (RelativeLayout) findViewById(R.id.publisher_container);*/
    mSubscriberViewContainer = (ConstraintLayout) findViewById(R.id.subscriber_container);
  ...
  public void onDisableLocalVideo(boolean video) {
    if (!video) {
      ...
      mSubscriberViewContainer.addView(mLocalAudioOnlyImage);
        } else {
      mSubscriberViewContainer.removeView(mLocalAudioOnlyImage);
        }
...
//    mContainer.removeView(subscriber.getView());
  ...
  private void calculateLayout() {
    ConstraintSetHelper set = new ConstraintSetHelper(R.id.subscriber_container);
    ...
    set.layoutViewWithTopBound(R.id.publisher_view_id, R.id.subscriber_container);
    set.layoutViewWithBottomBound(getResIdForSubscriberIndex(0), R.id.subscriber_container);
    set.layoutViewAllContainerWide(R.id.publisher_view_id,R.id.subscriber_container);
    set.layoutViewAllContainerWide(getResIdForSubscriberIndex(0), R.id.subscriber_container);
    ...
    set.layoutViewWithBottomBound(getResIdForSubscriberIndex(size - 2), R.id.subscriber_container);
    set.layoutViewWithBottomBound(getResIdForSubscriberIndex(size - 1), R.id.subscriber_container);
  } else if (size > 1) {
    // Pub  | Sub1
    // Sub2 | Sub3
    // Sub3 | Sub4
    ...
    set.layoutViewWithTopBound(R.id.publisher_view_id, R.id.subscriber_container);
    set.layoutViewWithTopBound(getResIdForSubscriberIndex(0), R.id.subscriber_container);
    ...
    set.layoutViewWithBottomBound(getResIdForSubscriberIndex(size - 1), R.id.subscriber_container);
        ...
        set.applyToLayout(mSubscriberViewContainer, true);
  }
